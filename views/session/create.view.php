    ...
    <form class="space-y-6" action="/session" method="POST">
      <div>
        ...
        <div class="mt-2">
          ...
          value="<?=  old('email') ;?>">
            <?php if (isset($errors['email'])) : ?> <!--代わりにcontrollerクラスで空投稿の確認。エラーが発生したら、内容を表示 -->
                <p class="text-red-500 rext-xs mt-2"><?= $errors['email']?></p>
            <?php endif ;?>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="password" 
            ...
            <?php if (isset($errors['password'])) : ?> <!--代わりにcontrollerクラスで空投稿の確認。エラーが発生したら、内容を表示 -->
                <p class="text-red-500 rext-xs mt-2"><?= $errors['password']?></p>
            <?php endif ;?>
        </div>
      </div>
